...
{
    public abstract class MapsWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static MapsWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(MapsWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<MapsDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<MapsDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<MapsDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<MapsDbContext, Task<T>> func)
        {
            T result;
